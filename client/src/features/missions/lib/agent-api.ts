...
import { ApiResponseError, parseApiJson, readApiJson as json } from '../../../lib/api-response'
import i18n from '../../../lib/i18n'
import { coerceRailPrStateSnapshot } from '../../delivery/lib/pr-delivery'
import type {
  RailDeliveryOutcome,
...
export interface AgentPrDecisionEnvelope {
  executionManifest?: import('../../projects/types/multi-repo').RunExecutionManifest | null
  repositoryDeliveries?: import('../../projects/types/multi-repo').RepositoryDeliverySnapshot[]
  kind: 'pr_decision'
  prDeliveryId: string
  railIndex: number
  projectId: string
