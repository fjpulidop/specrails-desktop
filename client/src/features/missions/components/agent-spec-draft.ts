...
// JSON object (taught in server/modules/missions/runtime/agent-operator-prompt.ts; same field shape as
// Explore's server-side protocol — see server/modules/specs/runtime/spec-draft-parser.ts and
...
import { SPEC_DRAFT_DEFAULTS, type SpecDraft, type SpecDraftPriority } from '../../specs/lib/spec-draft'
