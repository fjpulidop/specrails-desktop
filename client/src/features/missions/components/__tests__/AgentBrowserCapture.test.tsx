...
vi.mock('../../../browser/lib/native-browser', () => ({
...
vi.mock('../../../browser/components/browser-capture/NativeBrowserPane', () => ({
...
vi.mock('../../../browser/components/browser-capture/BrowserCaptureModal', () => ({
