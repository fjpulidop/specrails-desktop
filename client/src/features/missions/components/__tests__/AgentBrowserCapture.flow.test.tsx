...
vi.mock('../../../browser/lib/browser-capture', async original => ({
  ...await original<typeof import('../../../browser/lib/browser-capture')>(), uploadCaptureImage: fixture.uploadPending,
}))
vi.mock('../../../browser/lib/native-browser', async original => ({
  ...await original<typeof import('../../../browser/lib/native-browser')>(),
...
vi.mock('../../../browser/components/browser-capture/useBrowserCaptureSession', () => ({
