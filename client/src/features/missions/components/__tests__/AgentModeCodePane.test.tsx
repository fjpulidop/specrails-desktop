...
vi.mock('../../../code/pages/CodePage', () => ({ default: (props: { initialPath: string | null; initialRepositoryId?: string; onSelectedPathChange: (path: string) => void; onRepositoryChange: (id: string) => void }) => <div>
