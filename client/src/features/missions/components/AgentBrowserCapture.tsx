...
import { NativeBrowserModal } from '../../browser/components/browser-capture/NativeBrowserPane'
import { isNativeBrowserCaptureAvailable, normalizeAddress } from '../../browser/lib/native-browser'
import { useAgentWorkspace } from '../context/AgentWorkspaceContext'
import { useAgentChat } from '../context/AgentChatContext'
import { uploadAgentAttachment } from '../lib/agent-api'
import { dataUrlToFile } from '../../../lib/data-url'
import type { CaptureResult } from '../../browser/lib/browser-capture'
