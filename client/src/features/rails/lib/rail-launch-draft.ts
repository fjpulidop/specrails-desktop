...
// lives at server/modules/delivery/runtime/rail-launch-parser.ts and MUST stay byte-identical
...
import { parseJsonTolerant } from '../../../lib/json-tolerant'
import { parseFollowUpInput, type PrFollowUp } from '../../delivery/lib/pr-follow-up-scope'
