...
- [components/DocsDialog.tsx](components/DocsDialog.tsx)
- [pages/DocsPage.tsx](pages/DocsPage.tsx)
...
Run the adjacent tests with `npm run test --prefix client -- src/features/docs`.
