...
- [components/terminal/BottomPanel.tsx](components/terminal/BottomPanel.tsx)
- [components/terminal/PanelChevronButton.tsx](components/terminal/PanelChevronButton.tsx)
- [context/TerminalsContext.tsx](context/TerminalsContext.tsx)
...
Run the adjacent tests with `npm run test --prefix client -- src/features/terminals`.
