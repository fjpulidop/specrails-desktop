...
import { DEFAULT_TERMINAL_SETTINGS, type TerminalSettings } from '../../../settings/lib/terminal-settings-types'
import { TERMINAL_SETTINGS_UPDATED_EVENT, type TerminalSettingsUpdatedEventDetail } from '../../../settings/lib/terminal-settings-events'
import { registerTauriDragDrop } from '../../../../lib/tauri-drag-drop'
import type { ProviderId } from '../../../providers/lib/provider-capabilities'
