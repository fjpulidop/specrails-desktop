...
## Launch-Karten und Run-Karten

- **Der Agent schlägt vor, du drückst Play.** Bitte ihn, Specs auf ein Rail zu legen („bereite #12 und #14 auf einem Rail vor“), und statt es zu beschreiben, gibt er dir eine **Launch-Karte**: das Rail (oder ein neues), die Specs, Engine, Modell, Aufwand, Profil, Loop, optional Ziel-PR und Basis-Branch — alles mit seiner Empfehlung vorausgefüllt und alles editierbar. Ändere, was du willst, und drücke **Play**. Sagst du „starte es jetzt“, startet er direkt.
- **Eine Karte begleitet den Run.** Nach Play friert der Vorschlag als „Gestartet → Rail N“ ein und eine **Run-Karte** übernimmt: Status, verstrichene Zeit, was die Pipeline gerade tut, Log-Button und Stopp. Ist die Arbeit bereit zur Prüfung, wird dieselbe Karte zur bekannten PR-Karte (PR erstellen, lokal integrieren, verwerfen).
- **Fehler melden sich.** Schlägt ein Run fehl oder bleibt er hängen, zeigt die Karte den Grund im Klartext und bietet die echten Optionen — Fortsetzen, Wiederherstellen, Freigeben, Neu starten, Verwerfen — und der Agent postet ein kurzes Briefing, was passiert ist und was er empfiehlt. Er setzt nie von allein fort oder startet neu; du entscheidest über die Karte.
