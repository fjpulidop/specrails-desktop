...
| [MCP server](mcp.md) | …you want to drive the app from an MCP client (Codex, Claude Desktop, Cursor, your own agent) |
...
- **"How do I connect Codex CLI or the desktop app?"** → [Codex MCP setup and verification](agents/mcp.md)
