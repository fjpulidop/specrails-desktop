...
App-level registry of user external MCP servers (discovered from provider native configs + custom entries) with a per-provider activation matrix, injected into mission agent spawns.
