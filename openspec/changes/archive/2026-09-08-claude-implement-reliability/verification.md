...
- `server/modules/execution/runtime/interactive-job-session.ts`: `_trackBackgroundTasks` tracks the Claude roster, but the auto-settle branch calls `_noteOrphanedBackgroundTasks()` followed by `_finalizeQuiescent()`. The warning acknowledges task loss instead of preventing premature completion.
- `server/modules/loops/runtime/loop-command-catalog.ts`: the generic verify prompt requests tooling checks without explicitly requiring evidence of implementation; the generic fix prompt associates missing feature work with a PASS verdict and restricts FAIL to failing checks.
- `server/modules/loops/runtime/loop-factory.ts` and `server/modules/loops/runtime/loop-templates.ts`: factory/lifecycle goals need to state conditions to prove, including implementation scope, instead of presupposing a verification outcome.
...
```sh
npx vitest run server/modules/execution/runtime/interactive-job-session.test.ts server/modules/loops/runtime/loop-run-manager.test.ts server/modules/execution/runtime/queue-manager.test.ts server/modules/loops/runtime/loop-executors.test.ts server/modules/loops/runtime/loop-executors.interactive.test.ts server/modules/loops/runtime/loop-command-catalog.test.ts server/modules/loops/runtime/loop-factory.test.ts server/modules/loops/runtime/loop-graph.test.ts server/loop-implementation-recovery.test.ts server/modules/loops/runtime/loop-templates.test.ts server/modules/loops/runtime/loop-constants.test.ts server/opsx-lifecycle-loop.test.ts server/modules/loops/runtime/loop-decider.test.ts server/modules/loops/runtime/loop-runs-store.test.ts server/modules/loops/runtime/loop-step-idle.test.ts server/loop-executors-state.test.ts server/openspec-runtime-plugin.test.ts server/providers/claude-adapter.test.ts server/util/cli-prompt.test.ts server/providers/runtime.test.ts server/modules/execution/runtime/spawn-lifecycle.test.ts server/modules/missions/runtime/agent-chat-manager.test.ts server/agent-live-steering.test.ts server/agent-native-transports.test.ts server/agent-native-steering.test.ts server/agent-mcp-config.test.ts server/providers/claude-live-session.test.ts server/modules/conversations/runtime/explore-stdin-session.test.ts server/modules/conversations/runtime/chat-manager.test.ts server/modules/accounting/runtime/result-event.test.ts
```
