...
## What changes
- Revise `STAR_WARS_PALETTE` in `client/src/features/settings/lib/themes.ts` so background/elevation colors are desaturated neutral deep-space black, primary/info are a saturated 212-215 degree Jedi blue, and secondary is a low-saturation steel-gray/silver accent.
