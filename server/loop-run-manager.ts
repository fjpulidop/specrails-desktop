...
import { validateRuntimeDeveloperOverride, type RuntimeDeveloperOverride } from './agent-runtime-settings'
/**
...
export class LoopRunManager {
  ...
  async run(req: LoopRunRequest): Promise<LoopRunResult> {
    ...
    req = { ...req, runtimeDeveloperOverride: validateRuntimeDeveloperOverride(req.runtimeDeveloperOverride), graph: structuredClone(req.graph) }
