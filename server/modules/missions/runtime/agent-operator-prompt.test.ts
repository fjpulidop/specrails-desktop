...
// (client/src/features/missions/components/agent-problem-frame.ts) and the server gate
// (server/modules/missions/runtime/agent-spec-framing.ts) both depend on the model being taught this
