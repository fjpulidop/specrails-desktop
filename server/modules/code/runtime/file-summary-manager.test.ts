...
vi.mock('../../accounting/runtime/ai-invocations', async () => {
  const actual = await vi.importActual<typeof import('../../accounting/runtime/ai-invocations')>('../../accounting/runtime/ai-invocations')
  return {
    ...actual,
    recordInvocation: (db: import('../../../db').DbInstance, input: import('../../accounting/runtime/ai-invocations').RecordInput) => {
      ...
      return actual.recordInvocation(db, patched as import('../../accounting/runtime/ai-invocations').RecordInput)
    },
  }
})
