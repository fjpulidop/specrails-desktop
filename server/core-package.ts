 ...
 *
 * Floor bumped to 4.12.0 — the version that ships the Kimi provider target
 * (`.kimi-code/` skills + roles). It also changes the `npx` package-spec string,
 ...
 */
export const CORE_PACKAGE_SPEC = 'specrails-core@^4.12.0'
