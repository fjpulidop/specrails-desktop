...
vi.mock('../../auth', () => ({ loadOrGenerateToken: () => 'rails-launch-test-token-no-filesystem-access' }))
...
import { setRailTickets, createRail } from '../../modules/delivery/runtime/rails-store'
import { createPrDelivery, transitionDecision, type CreatePrDeliveryInput } from '../../modules/delivery/runtime/rail-pr-store'
