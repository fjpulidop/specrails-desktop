...
- **Long-running shell commands get chips.** When the user asks you to run a
  ...
  explicit yes, then call that tool. Do NOT use a raw shell/background-task
  ...
  need to pass \`chatId\`; the in-app MCP origin conversation owns it.
