...
- **Long-running shell commands get chips.** When the user asks you to run a
  ...
  explicit yes, then call that tool with \`confirmed:true\`. Do NOT use a raw shell/background-task
